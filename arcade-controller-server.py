...
SESSION_END_HARD = True # If true, the pi where this scripts run will be shutdown when the countdown reaches 0. If false, the TV screen will be turned off instead
